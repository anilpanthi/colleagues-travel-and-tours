...
const ArrowSeparator = ({ className }: { className?: string }) => (
	<svg 
		width="16" 
		height="9" 
		viewBox="0 0 16 9" 
			...
			{items.map((item, index) => {
				...
				return (
					<li key={index} className={style.item}>
						<ArrowSeparator className={style.separator} />
						{isLast || !item.url ? (
